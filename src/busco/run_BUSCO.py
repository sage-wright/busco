...
def _parse_args():
    ...
    optional.add_argument("--download_path", dest="download_path", required=False,
                          help="Specify local filepath for storing BUSCO dataset downloads")

    optional.add_argument("--datasets_version", dest="datasets_version", required=False,
                          help="Specify the version of BUSCO datasets, e.g. odb10")

    optional.add_argument("--download_base_url", dest="download_base_url", required=False,
    ...
    optional.add_argument("--metaeuk_rerun_parameters", dest="metaeuk_rerun_parameters", required=False,
    ...
    optional.add_argument("--augustus", dest="use_augustus", action="store_true", required=False,
    ...
    optional.add_argument("--long", action="store_true", required=False, dest="long",
